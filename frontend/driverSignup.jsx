...
const SignupFormDriver = () => {
  ...
  return (  
    ...
    <div className="bg-cyan-300 p-8 rounded-3xl shadow-lg max-w-md mx-auto mt-10 ">
      <h1 className="text-3xl font-bold mb-6 text-center">Driver Sign Up</h1>
         ...
         <form  onSubmit={handleSubmit} className="flex flex-col space-y-2">
            ...
            <input className="border-2 rounded-xl p-3" type="email" placeholder="abc@gmail.com" value={email} onChange={(e)=> setEmail(e.target.value)} required /><br />
              ...
              <input className="border-2 rounded-xl p-3" type="text" placeholder="20223310.." value={autoID} onChange={(e)=> setStudentID(e.target.value)} required/><br />
                  ...
                  <input className="border-2 rounded-xl p-3" type="password" placeholder="Confirm password:" value={password} onChange={(e)=> setCpassword(e.target.value)} required/><br />
